/* ============================================
   ...
   Service API - Version React Native
   ============================================ */

import axios from 'axios';
import { Platform } from 'react-native';

// Configuration de l'URL API selon la plateforme
const getApiBaseUrl = () => {
  if (__DEV__) {
    // En développement
    if (Platform.OS === 'web') {
    ...
    // Sur mobile: utilise l'IP de votre PC
    // TODO: Remplacez par votre IP actuelle
    return 'http://192.168.1.200:5000';
  }
  
  // En production
  return process.env.EXPO_PUBLIC_API_BASE_URL || 'https://votre-api-production.com';
};
...
apiClient.interceptors.response.use(
  ...
  (error) => {
    ...
    if (error.code === 'ERR_NETWORK' || error.message === 'Network Error') {
      ...
      console.error('   5. Sur mobile: IP correcte dans api.js ?');
      console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  if (error.code === 'ERR_NETWORK' || error.message === 'Network Error') {
    ...
    response.details = {
      ...
      solutions: [
        ...
        'Vérifiez l\'URL: ' + API_BASE_URL,
        Platform.OS !== 'web' ? 'Vérifiez que votre mobile est sur le même réseau WiFi' : null,
