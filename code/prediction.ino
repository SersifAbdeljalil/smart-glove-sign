...
void sendDataToServer() {
  ...
  http.setTimeout(10000); // Timeout 10s pour Vercel
...
void setup() {
  ...
  Serial.println("\n🚀 Démarrage ESP32 Smart Glove - VERSION VERCEL");
  Serial.println("URL: https://backend-smart-glov-bcii.vercel.app");
  ...
  Serial.println("\n✅ Système prêt!");
  Serial.println("Les données seront envoyées vers Vercel toutes les 500ms");
}
...
void loop() {
  ...
  if (now - lastUpdateTime >= 100) {
    ...
    Serial.println("========== SMART GLOVE - VERCEL ==========");
